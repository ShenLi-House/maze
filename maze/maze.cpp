...
void startup()
{
	...
	////加载角色移动的图片帧素材
	//loadimage(&playerMove[0], _T("resource/images/1.png"));
	//loadimage(&playerMove[1], _T("resource/images/2.png"));
	//loadimage(&playerMove[2], _T("resource/images/3.png"));
	//loadimage(&playerMove[3], _T("resource/images/4.png"));
	//loadimage(&playerMove[4], _T("resource/images/5.png"));
	//loadimage(&playerMove[5], _T("resource/images/6.png"));
}
//音效
void bgm1() {
	// 打开音乐
...
//背景音乐
void bgm() {
	const wchar_t* musicFilePath = L"resource/music/bgmx.mp3"; // 替换为你的音乐文件路径
	playBackgroundMusic(musicFilePath);

	while (1) {
		

		// 在这里可以添加其他逻辑来维持音乐的播放，或者使用条件等待信号
		...
		Sleep(1000); // 示例：每秒检查一次条件
	}
	// 如果有需要结束音乐播放的地方，可以在这里添加关闭音乐的代码
}
